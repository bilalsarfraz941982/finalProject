  ...
  return (
    <div className='mainbox'>
        ...
        <div className='topthree'>
          ...
          <div className='details'>
            <form>
              ...
              <button style={{color:"rgb(73,94,87)", marginLeft:"150px",marginTop:"10px", fontSize:"80%" ,borderRadius:"50px" ,height:"35px" , width:"150px"}}>Sign in</button>
            </form>
          </div>
        </div>
      </div>
      <div className='rightbox' style={{backgroundColor:"rgb(73,94,87)", height:"400px" , width:"400px" ,borderRadius:"500px"}}>
         ...
         <h3 style={{color:"white" ,textAlign:'center', marginTop:"20px", fontWeight:"200"}}>Sin up and discover a great <br></br> amount of new discounts and offers!!!</h3>
         <button style={{color:"rgb(73,94,87)", backgroundColor:"rgb(244, 206, 20)",marginLeft:"120px",marginTop:"50px", fontSize:"80%" ,borderRadius:"50px" ,height:"35px" , width:"150px"}}>Sing up</button>
      </div>
    </div>
  )
}
