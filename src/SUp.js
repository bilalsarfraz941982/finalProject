      ...
      <div className='rightbox'>
        <div className='topthree'>
          ...
          <div className='details'>
            <form>
              <input type='text' id='name' className='name' placeholder='  Name' style={{backgroundColor:"rgb(234, 217, 135)",height:"30px",width:"300px" , marginBottom:"10px",marginTop:"10px", borderRadius:"20px" , marginLeft:"80px"}}></input>
